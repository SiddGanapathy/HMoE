...
module pseudo_moe_pseudo_moe_Pipeline_VITIS_LOOP_208_14 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [61:0] sext_ln129_1;
output  [5:0] acc_out_address0;
output   acc_out_ce0;
input  [31:0] acc_out_q0;
...
reg   [31:0] acc_out_load_reg_146;
wire   [63:0] zext_ln208_fu_105_p1;
wire    ap_block_pp0_stage0_01001;
reg   [6:0] o_fu_50;
wire   [6:0] add_ln208_fu_99_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln208_fu_93_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln208_fu_93_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign acc_out_address0 = zext_ln208_fu_105_p1;

assign add_ln208_fu_99_p2 = (ap_sig_allocacmp_o_1 + 7'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_gmem12_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_gmem12_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end
...
assign icmp_ln208_fu_93_p2 = ((ap_sig_allocacmp_o_1 == 7'd64) ? 1'b1 : 1'b0);
...
assign m_axi_gmem12_WDATA = acc_out_load_reg_146;
...
assign zext_ln208_fu_105_p1 = ap_sig_allocacmp_o_1;

endmodule //pseudo_moe_pseudo_moe_Pipeline_VITIS_LOOP_208_14
