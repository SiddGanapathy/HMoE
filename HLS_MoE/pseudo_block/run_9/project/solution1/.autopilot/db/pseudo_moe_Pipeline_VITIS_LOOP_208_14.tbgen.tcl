set moduleName pseudo_moe_Pipeline_VITIS_LOOP_208_14
set isTopModule 0
...
set C_modelName {pseudo_moe_Pipeline_VITIS_LOOP_208_14}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem12 int 32 regular {axi_master 1}  }
	{ sext_ln129_1 int 62 regular  }
	{ acc_out float 32 regular {array 64 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem12", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln129_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "acc_out", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln129_1 sc_in sc_lv 62 signal 1 } 
	{ acc_out_address0 sc_out sc_lv 6 signal 2 } 
	{ acc_out_ce0 sc_out sc_logic 1 signal 2 } 
	{ acc_out_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln129_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln129_1", "role": "default" }} , 
 	...
 	{ "name": "acc_out_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_out", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln129_1 { ap_none {  { sext_ln129_1 in_data 0 62 } } }
	acc_out { ap_memory {  { acc_out_address0 mem_address 1 6 }  { acc_out_ce0 mem_ce 1 1 }  { acc_out_q0 mem_dout 0 32 } } }
}
