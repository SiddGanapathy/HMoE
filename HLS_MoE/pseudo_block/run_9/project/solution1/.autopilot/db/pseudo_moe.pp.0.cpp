# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_9/src/pseudo_moe.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_9/src/pseudo_moe.cpp" 2
...
# 2 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_9/src/pseudo_moe.cpp" 2
...
#pragma HLS INLINE off
 ...
 VITIS_LOOP_19_1: for (int o = 0; o < D; o++) {
        float partial[LANES];
#pragma HLS ARRAY_PARTITION variable=partial complete

 VITIS_LOOP_23_2: for (int lane = 0; lane < LANES; lane++) {
#pragma HLS UNROLL
 partial[lane] = 0.0f;
        }
...
#pragma HLS PIPELINE II=1
 ...
 VITIS_LOOP_32_4: for (int lane = 0; lane < LANES; lane++) {
#pragma HLS UNROLL
 const int i = g * LANES + lane;
        ...
        VITIS_LOOP_41_5: for (int lane = 0; lane < LANES; lane++) {
#pragma HLS UNROLL
 acc += partial[lane];
        }
...
#line 16 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_9/scripts/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=pseudo_moe
# 63 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_9/src/pseudo_moe.cpp"
...
#pragma HLS PIPELINE II=1
 acc_out[d] = 0.0f;
        ...
        VITIS_LOOP_178_10: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 acc_out[o] += gates[0] * expert_result[o];
        ...
        VITIS_LOOP_186_11: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 acc_out[o] += gates[1] * expert_result[o];
        ...
        VITIS_LOOP_194_12: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 acc_out[o] += gates[2] * expert_result[o];
        ...
        VITIS_LOOP_202_13: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 acc_out[o] += gates[3] * expert_result[o];
        }


        VITIS_LOOP_208_14: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
