# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_7/src/pseudo_moe.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_7/src/pseudo_moe.cpp" 2
...
# 2 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_7/src/pseudo_moe.cpp" 2
...
#line 16 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_7/scripts/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=pseudo_moe
# 63 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_7/src/pseudo_moe.cpp"
...
#pragma HLS PIPELINE II=1
 input_local[n][d] = input[n * D + d];
    ...
    VITIS_LOOP_115_3: for (int k = 0; k < D * D; k++) {
#pragma HLS PIPELINE II=1
 w0_local[k] = w0[k];
    }

    VITIS_LOOP_120_4: for (int k = 0; k < D * D; k++) {
#pragma HLS PIPELINE II=1
 w1_local[k] = w1[k];
    }

    VITIS_LOOP_125_5: for (int k = 0; k < D * D; k++) {
#pragma HLS PIPELINE II=1
 w2_local[k] = w2[k];
    }

    VITIS_LOOP_130_6: for (int k = 0; k < D * D; k++) {
#pragma HLS PIPELINE II=1
 w3_local[k] = w3[k];
    }
    ...
    VITIS_LOOP_139_7: for (int n = 0; n < N; n++) {
        ...
        VITIS_LOOP_150_8: for (int e = 0; e < E; e++) {
            float acc = b_gate[e];

            VITIS_LOOP_153_9: for (int d = 0; d < D; d++) {
        ...
        VITIS_LOOP_167_10: for (int e = 0; e < E; e++) {
#pragma HLS PIPELINE II=1
 exp_values[e] = expf(logits[e] - max_logit);
            exp_sum += exp_values[e];
        }

        VITIS_LOOP_173_11: for (int e = 0; e < E; e++) {
#pragma HLS PIPELINE II=1
 gates[e] = exp_values[e] / exp_sum;
        ...
        VITIS_LOOP_180_12: for (int d = 0; d < D; d++) {
#pragma HLS PIPELINE II=1
 acc_out[d] = 0.0f;
        }
        ...
        VITIS_LOOP_188_13: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 acc_out[o] += gates[0] * expert_result[o];
        ...
        VITIS_LOOP_196_14: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 acc_out[o] += gates[1] * expert_result[o];
        ...
        VITIS_LOOP_204_15: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 acc_out[o] += gates[2] * expert_result[o];
        ...
        VITIS_LOOP_212_16: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 acc_out[o] += gates[3] * expert_result[o];
        }


        VITIS_LOOP_218_17: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
