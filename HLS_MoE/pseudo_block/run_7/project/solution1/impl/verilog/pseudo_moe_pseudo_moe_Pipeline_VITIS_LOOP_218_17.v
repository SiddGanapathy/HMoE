...
module pseudo_moe_pseudo_moe_Pipeline_VITIS_LOOP_218_17 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln218_fu_105_p1;
wire    ap_block_pp0_stage0_01001;
reg   [6:0] o_fu_50;
wire   [6:0] add_ln218_fu_99_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln218_fu_93_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln218_fu_93_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign acc_out_address0 = zext_ln218_fu_105_p1;

assign add_ln218_fu_99_p2 = (ap_sig_allocacmp_o_1 + 7'd1);
...
assign icmp_ln218_fu_93_p2 = ((ap_sig_allocacmp_o_1 == 7'd64) ? 1'b1 : 1'b0);
...
assign zext_ln218_fu_105_p1 = ap_sig_allocacmp_o_1;

endmodule //pseudo_moe_pseudo_moe_Pipeline_VITIS_LOOP_218_17
