...
#pragma HLS PIPELINE II=1
        ...
        // --------------------------------------------------
        // Replicate sample input into independent buffers.
        // Each DATAFLOW expert reads only its own copy.
        // --------------------------------------------------
        float x0[D];
        float x1[D];
        float x2[D];
...
#pragma HLS PIPELINE II=1
        ...
        // --------------------------------------------------
        // DATAFLOW region:
        // Four independent expert processes + combine stage
        // --------------------------------------------------
