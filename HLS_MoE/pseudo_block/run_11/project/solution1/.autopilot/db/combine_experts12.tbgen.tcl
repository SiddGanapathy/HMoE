set moduleName combine_experts12
set isTopModule 0
...
set C_modelName {combine_experts12}
set C_modelType { void 0 }
set C_modelArgList {
	{ gates float 32 regular {array 4 { 1 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gates", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ gates_address0 sc_out sc_lv 2 signal 0 } 
	{ gates_ce0 sc_out sc_logic 1 signal 0 } 
	{ gates_q0 sc_in sc_lv 32 signal 0 } 
	{ gates_address1 sc_out sc_lv 2 signal 0 } 
	{ gates_ce1 sc_out sc_logic 1 signal 0 } 
	{ gates_q1 sc_in sc_lv 32 signal 0 } 
	{ r0_address0 sc_out sc_lv 6 signal 1 } 
	{ r0_ce0 sc_out sc_logic 1 signal 1 } 
	{ r0_q0 sc_in sc_lv 32 signal 1 } 
	{ r1_address0 sc_out sc_lv 6 signal 2 } 
	{ r1_ce0 sc_out sc_logic 1 signal 2 } 
	{ r1_q0 sc_in sc_lv 32 signal 2 } 
	{ r2_address0 sc_out sc_lv 6 signal 3 } 
	{ r2_ce0 sc_out sc_logic 1 signal 3 } 
	{ r2_q0 sc_in sc_lv 32 signal 3 } 
	{ r3_address0 sc_out sc_lv 6 signal 4 } 
	{ r3_ce0 sc_out sc_logic 1 signal 4 } 
	{ r3_q0 sc_in sc_lv 32 signal 4 } 
	{ result_address0 sc_out sc_lv 6 signal 5 } 
	{ result_ce0 sc_out sc_logic 1 signal 5 } 
	{ result_we0 sc_out sc_logic 1 signal 5 } 
	{ result_d0 sc_out sc_lv 32 signal 5 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "gates", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0"},
			{"Name" : "r0", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67", "Port" : "r0", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "r1", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67", "Port" : "r1", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "r2", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67", "Port" : "r2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "r3", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67", "Port" : "r3", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "result", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67", "Port" : "result", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67", "Parent" : "0", "Child" : ["2", "3", "4", "5", "6", "7", "8", "9"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67.fadd_32ns_32ns_32_2_full_dsp_1_U581", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67.fadd_32ns_32ns_32_2_full_dsp_1_U582", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67.fadd_32ns_32ns_32_2_full_dsp_1_U583", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67.fmul_32ns_32ns_32_2_max_dsp_1_U584", "Parent" : "1"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67.fmul_32ns_32ns_32_2_max_dsp_1_U585", "Parent" : "1"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67.fmul_32ns_32ns_32_2_max_dsp_1_U586", "Parent" : "1"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67.fmul_32ns_32ns_32_2_max_dsp_1_U587", "Parent" : "1"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_combine_experts12_Pipeline_VITIS_LOOP_64_1_fu_67.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	gates { ap_memory {  { gates_address0 mem_address 1 2 }  { gates_ce0 mem_ce 1 1 }  { gates_q0 mem_dout 0 32 }  { gates_address1 MemPortADDR2 1 2 }  { gates_ce1 MemPortCE2 1 1 }  { gates_q1 MemPortDOUT2 0 32 } } }
	r0 { ap_memory {  { r0_address0 mem_address 1 6 }  { r0_ce0 mem_ce 1 1 }  { r0_q0 mem_dout 0 32 } } }
	r1 { ap_memory {  { r1_address0 mem_address 1 6 }  { r1_ce0 mem_ce 1 1 }  { r1_q0 mem_dout 0 32 } } }
	r2 { ap_memory {  { r2_address0 mem_address 1 6 }  { r2_ce0 mem_ce 1 1 }  { r2_q0 mem_dout 0 32 } } }
	r3 { ap_memory {  { r3_address0 mem_address 1 6 }  { r3_ce0 mem_ce 1 1 }  { r3_q0 mem_dout 0 32 } } }
