...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename gates_i \
    op interface \
    ports { gates_i_address0 { O 2 vector } gates_i_ce0 { O 1 bit } gates_i_we0 { O 1 bit } gates_i_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'gates_i'"
}
}
