...
`timescale 1ns/1ps
module pseudo_moe_dataflow_in_loop_VITIS_LOOP_149_4_1_gates_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 32,
    AddressRange = 4,
    AddressWidth = 2,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        pseudo_moe_dataflow_in_loop_VITIS_LOOP_149_4_1_gates_RAM_AUTO_1R1W_memcore pseudo_moe_dataflow_in_loop_VITIS_LOOP_149_4_1_gates_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
