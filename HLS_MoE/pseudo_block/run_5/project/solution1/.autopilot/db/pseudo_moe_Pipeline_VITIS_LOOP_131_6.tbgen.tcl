set moduleName pseudo_moe_Pipeline_VITIS_LOOP_131_6
set isTopModule 0
...
set C_modelName {pseudo_moe_Pipeline_VITIS_LOOP_131_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem12 int 32 regular {axi_master 1}  }
	{ sext_ln131 int 62 regular  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "gmem12", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control_r"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln131", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln131 sc_in sc_lv 62 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln131", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln131", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln131 { ap_none {  { sext_ln131 in_data 0 62 } } }
}
