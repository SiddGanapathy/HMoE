...
module pseudo_moe_pseudo_moe_Pipeline_VITIS_LOOP_100_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [6:0] d_1_fu_46;
wire   [6:0] add_ln100_fu_83_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_d;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln100_fu_77_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln100_fu_77_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln100_fu_83_p2 = (ap_sig_allocacmp_d + 7'd1);
...
assign icmp_ln100_fu_77_p2 = ((ap_sig_allocacmp_d == 7'd64) ? 1'b1 : 1'b0);
...
endmodule //pseudo_moe_pseudo_moe_Pipeline_VITIS_LOOP_100_6
