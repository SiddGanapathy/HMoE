set moduleName pseudo_moe_Pipeline_VITIS_LOOP_24_2
set isTopModule 0
...
set C_modelName {pseudo_moe_Pipeline_VITIS_LOOP_24_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 0}  }
	{ sext_ln80 int 62 regular  }
	{ x float 32 regular {array 64 { 1 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "w_gate","offset": { "type": "dynamic","port_name": "w_gate","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln80", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln80 sc_in sc_lv 62 signal 1 } 
	...
	{ p_out1 sc_out sc_lv 32 signal 4 } 
	{ p_out1_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ p_out2 sc_out sc_lv 32 signal 5 } 
	{ p_out2_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ p_out3 sc_out sc_lv 32 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln80", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln80", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln80 { ap_none {  { sext_ln80 in_data 0 62 } } }
	x { ap_memory {  { x_address0 mem_address 1 6 }  { x_ce0 mem_ce 1 1 }  { x_q0 mem_dout 0 32 }  { x_address1 MemPortADDR2 1 6 }  { x_ce1 MemPortCE2 1 1 }  { x_q1 MemPortDOUT2 0 32 } } }
