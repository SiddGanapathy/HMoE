# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_2/src/pseudo_moe.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_2/src/pseudo_moe.cpp" 2
...
# 2 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_2/src/pseudo_moe.cpp" 2
...
#pragma HLS ARRAY_PARTITION variable=partial complete
 ...
 VITIS_LOOP_19_1: for (int lane = 0; lane < LANES; lane++) {
#pragma HLS UNROLL
 partial[lane] = 0.0f;
    }

    VITIS_LOOP_24_2: for (int i = 0; i < D; i += LANES) {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_26_3: for (int lane = 0; lane < LANES; lane++) {
#pragma HLS UNROLL
...
#line 14 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_2/scripts/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=pseudo_moe
# 50 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_2/src/pseudo_moe.cpp"
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 ...
 float logits[E];
    ...
    VITIS_LOOP_71_1: for (int n = 0; n < N; n++) {

        VITIS_LOOP_73_2: for (int d = 0; d < D; d++) {
#pragma HLS PIPELINE II=1
 x[d] = input[n * D + d];
        }
        ...
        VITIS_LOOP_80_3: for (int e = 0; e < E; e++) {
        ...
        float exp_sum = 0.0f;
        VITIS_LOOP_89_4: for (int e = 0; e < E; e++) {
#pragma HLS PIPELINE II=1
 exp_values[e] = expf(logits[e] - max_logit);
            exp_sum += exp_values[e];
        }

        VITIS_LOOP_95_5: for (int e = 0; e < E; e++) {
#pragma HLS PIPELINE II=1
 gates_out[n * E + e] = exp_values[e] / exp_sum;
        }

        VITIS_LOOP_100_6: for (int d = 0; d < D; d++) {
#pragma HLS PIPELINE II=1
 output[n * D + d] = 0.0f;
        }


        VITIS_LOOP_106_7: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 expert_result[o] = dot64(x, &w0[o * D], b0[o]);
        }
        VITIS_LOOP_110_8: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 output[n * D + o] += gates_out[n * E] * expert_result[o];
        }


        VITIS_LOOP_116_9: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 expert_result[o] = dot64(x, &w1[o * D], b1[o]);
        }
        VITIS_LOOP_120_10: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 output[n * D + o] += gates_out[n * E + 1] * expert_result[o];
        }


        VITIS_LOOP_126_11: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 expert_result[o] = dot64(x, &w2[o * D], b2[o]);
        }
        VITIS_LOOP_130_12: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 output[n * D + o] += gates_out[n * E + 2] * expert_result[o];
        }


        VITIS_LOOP_136_13: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 expert_result[o] = dot64(x, &w3[o * D], b3[o]);
        }
        VITIS_LOOP_140_14: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
