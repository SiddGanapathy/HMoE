...
module pseudo_moe_pseudo_moe_Pipeline_VITIS_LOOP_116_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] tmp_4_fu_141_p6;
wire   [31:0] grp_fu_108_p2;
reg   [31:0] div_reg_197;
wire    ap_block_pp0_stage0_01001;
reg   [2:0] e_fu_60;
wire   [2:0] add_ln116_fu_131_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_e_2;
wire   [1:0] tmp_4_fu_141_p5;
reg    grp_fu_108_ce;
reg    ap_done_reg;
...
pseudo_moe_fdiv_32ns_32ns_32_6_no_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fdiv_32ns_32ns_32_6_no_dsp_1_U41(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln116_fu_125_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln116_fu_125_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln116_fu_131_p2 = (ap_sig_allocacmp_e_2 + 3'd1);
...
assign icmp_ln116_fu_125_p2 = ((ap_sig_allocacmp_e_2 == 3'd4) ? 1'b1 : 1'b0);
...
assign tmp_4_fu_141_p5 = ap_sig_allocacmp_e_2[1:0];

endmodule //pseudo_moe_pseudo_moe_Pipeline_VITIS_LOOP_116_5
