...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename acc_out_i \
    op interface \
    ports { acc_out_i_address0 { O 6 vector } acc_out_i_ce0 { O 1 bit } acc_out_i_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'acc_out_i'"
}
}
