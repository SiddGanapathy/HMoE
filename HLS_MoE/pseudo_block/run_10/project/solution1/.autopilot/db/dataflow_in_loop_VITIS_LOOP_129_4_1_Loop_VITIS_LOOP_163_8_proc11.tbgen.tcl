set moduleName dataflow_in_loop_VITIS_LOOP_129_4_1_Loop_VITIS_LOOP_163_8_proc11
set isTopModule 0
...
set C_modelName {dataflow_in_loop_VITIS_LOOP_129_4.1_Loop_VITIS_LOOP_163_8_proc11}
...
set C_modelArgList {
	...
	{ gates_i float 32 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "n_1", "interface" : "fifo", "bitwidth" : 4, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "gates_i", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ gates_i_din sc_out sc_lv 32 signal 5 } 
	{ gates_i_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ gates_i_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ gates_i_full_n sc_in sc_logic 1 signal 5 } 
	{ gates_i_write sc_out sc_logic 1 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "gates_i_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "gates_i", "role": "din" }} , 
 	{ "name": "gates_i_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "gates_i", "role": "num_data_valid" }} , 
 	{ "name": "gates_i_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "gates_i", "role": "fifo_cap" }} , 
 	{ "name": "gates_i_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gates_i", "role": "full_n" }} , 
 	{ "name": "gates_i_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gates_i", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "gates_i", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	gates_i { ap_fifo {  { gates_i_din fifo_data_in 1 32 }  { gates_i_num_data_valid fifo_status_num_data_valid 0 3 }  { gates_i_fifo_cap fifo_update 0 3 }  { gates_i_full_n fifo_status 0 1 }  { gates_i_write fifo_port_we 1 1 } } }
}
