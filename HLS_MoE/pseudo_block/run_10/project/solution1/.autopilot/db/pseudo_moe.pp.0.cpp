# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_10/src/pseudo_moe.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_10/src/pseudo_moe.cpp" 2
...
# 2 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_10/src/pseudo_moe.cpp" 2
...
#pragma HLS INLINE off
 ...
 VITIS_LOOP_20_1: for (int o = 0; o < D; o++) {
        float partial[LANES];
#pragma HLS ARRAY_PARTITION variable=partial complete

 VITIS_LOOP_24_2: for (int lane = 0; lane < LANES; lane++) {
#pragma HLS UNROLL
 partial[lane] = 0.0f;
        }

        VITIS_LOOP_29_3: for (int g = 0; g < GROUPS; g++) {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_31_4: for (int lane = 0; lane < LANES; lane++) {
#pragma HLS UNROLL
 const int i = g * LANES + lane;
        ...
        VITIS_LOOP_40_5: for (int lane = 0; lane < LANES; lane++) {
#pragma HLS UNROLL
 acc += partial[lane];
        }
...
# 63 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_10/src/pseudo_moe.cpp"
...
#pragma HLS ARRAY_PARTITION variable=w3_local cyclic factor=16 dim=1
 ...
 VITIS_LOOP_104_1: for (int n = 0; n < N; n++) {
        VITIS_LOOP_105_2: for (int d = 0; d < D; d++) {
#pragma HLS PIPELINE II=1
 input_local[n][d] = input[n * D + d];
    ...
    VITIS_LOOP_116_3: for (int k = 0; k < D * D; k++) {
#pragma HLS PIPELINE II=1
 w0_local[k] = w0[k];
        w1_local[k] = w1[k];
        w2_local[k] = w2[k];
    ...
    VITIS_LOOP_129_4: for (int n = 0; n < N; n++) {
        ...
        VITIS_LOOP_140_5: for (int e = 0; e < E; e++) {
            float acc = b_gate[e];

            VITIS_LOOP_143_6: for (int d = 0; d < D; d++) {
        ...
        VITIS_LOOP_157_7: for (int e = 0; e < E; e++) {
#pragma HLS PIPELINE II=1
 exp_values[e] = expf(logits[e] - max_logit);
            exp_sum += exp_values[e];
        }

        VITIS_LOOP_163_8: for (int e = 0; e < E; e++) {
#pragma HLS PIPELINE II=1
 gates[e] = exp_values[e] / exp_sum;
        ...
        VITIS_LOOP_170_9: for (int d = 0; d < D; d++) {
#pragma HLS PIPELINE II=1
 acc_out[d] = 0.0f;
        }
...
#pragma HLS DATAFLOW
 ...
 compute_expert<0>(input_local[n], w0_local, b0, expert_result0);
        compute_expert<1>(input_local[n], w1_local, b1, expert_result1);
        compute_expert<2>(input_local[n], w2_local, b2, expert_result2);
        compute_expert<3>(input_local[n], w3_local, b3, expert_result3);

        VITIS_LOOP_187_10: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
 acc_out[o] += gates[0] * expert_result0[o]
                        + gates[1] * expert_result1[o]
                        + gates[2] * expert_result2[o]
                        + gates[3] * expert_result3[o];
        }


        VITIS_LOOP_196_11: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE II=1
