set moduleName dataflow_in_loop_VITIS_LOOP_129_4_1_Loop_VITIS_LOOP_170_9_proc712_Pipeline_VITIS_1
set isTopModule 0
...
set C_modelName {dataflow_in_loop_VITIS_LOOP_129_4.1_Loop_VITIS_LOOP_170_9_proc712_Pipeline_VITIS.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ acc_out float 32 regular {array 64 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "acc_out", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ acc_out_address0 sc_out sc_lv 6 signal 0 } 
	{ acc_out_ce0 sc_out sc_logic 1 signal 0 } 
	{ acc_out_we0 sc_out sc_logic 1 signal 0 } 
	{ acc_out_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	acc_out { ap_memory {  { acc_out_address0 mem_address 1 6 }  { acc_out_ce0 mem_ce 1 1 }  { acc_out_we0 mem_we 1 1 }  { acc_out_d0 mem_din 1 32 } } }
}
