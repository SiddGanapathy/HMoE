# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_1/src/pseudo_moe.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_1/src/pseudo_moe.cpp" 2
...
# 3 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_1/src/pseudo_moe.cpp" 2
...
#line 14 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_1/scripts/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=pseudo_moe
# 21 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_1/src/pseudo_moe.cpp"
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 ...
 float logits[E];
    ...
    VITIS_LOOP_45_1: for (int n = 0; n < N; n++) {
#pragma HLS PIPELINE off
 ...
 float max_logit = -1.0e30f;
        ...
        VITIS_LOOP_53_2: for (int e = 0; e < E; e++) {
#pragma HLS PIPELINE off

 float acc = b_gate[e];

            VITIS_LOOP_58_3: for (int d = 0; d < D; d++) {
#pragma HLS PIPELINE off
 acc += input[n * D + d] * w_gate[e * D + d];
        ...
        VITIS_LOOP_75_4: for (int e = 0; e < E; e++) {
#pragma HLS PIPELINE off
 exp_values[e] = expf(logits[e] - max_logit);
            exp_sum += exp_values[e];
        }

        VITIS_LOOP_81_5: for (int e = 0; e < E; e++) {
#pragma HLS PIPELINE off
 gates_out[n * E + e] = exp_values[e] / exp_sum;
        ...
        VITIS_LOOP_89_6: for (int d = 0; d < D; d++) {
#pragma HLS PIPELINE off
 output[n * D + d] = 0.0f;
        }
        ...
        VITIS_LOOP_97_7: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE off

 float acc = b0[o];

            VITIS_LOOP_102_8: for (int i = 0; i < D; i++) {
#pragma HLS PIPELINE off
 acc += input[n * D + i] * w0[o * D + i];
        ...
        VITIS_LOOP_110_9: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE off
 output[n * D + o] +=
        ...
        VITIS_LOOP_119_10: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE off

 float acc = b1[o];

            VITIS_LOOP_124_11: for (int i = 0; i < D; i++) {
#pragma HLS PIPELINE off
 acc += input[n * D + i] * w1[o * D + i];
        ...
        VITIS_LOOP_132_12: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE off
 output[n * D + o] +=
        ...
        VITIS_LOOP_141_13: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE off

 float acc = b2[o];

            VITIS_LOOP_146_14: for (int i = 0; i < D; i++) {
#pragma HLS PIPELINE off
 acc += input[n * D + i] * w2[o * D + i];
        ...
        VITIS_LOOP_154_15: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE off
 output[n * D + o] +=
        ...
        VITIS_LOOP_163_16: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE off

 float acc = b3[o];

            VITIS_LOOP_168_17: for (int i = 0; i < D; i++) {
#pragma HLS PIPELINE off
 acc += input[n * D + i] * w3[o * D + i];
        ...
        VITIS_LOOP_176_18: for (int o = 0; o < D; o++) {
#pragma HLS PIPELINE off
 output[n * D + o] +=
