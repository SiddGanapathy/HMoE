...
module pseudo_moe_pseudo_moe_Pipeline_VITIS_LOOP_147_9 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
pseudo_moe_fdiv_32ns_32ns_32_6_no_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fdiv_32ns_32ns_32_6_no_dsp_1_U81(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln147_fu_125_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln147_fu_125_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln147_fu_131_p2 = (ap_sig_allocacmp_e_1 + 3'd1);
...
assign icmp_ln147_fu_125_p2 = ((ap_sig_allocacmp_e_1 == 3'd4) ? 1'b1 : 1'b0);
...
assign tmp_4_fu_141_p5 = ap_sig_allocacmp_e_1[1:0];

endmodule //pseudo_moe_pseudo_moe_Pipeline_VITIS_LOOP_147_9
