set moduleName pseudo_moe_Pipeline_VITIS_LOOP_109_3
set isTopModule 0
...
set C_modelName {pseudo_moe_Pipeline_VITIS_LOOP_109_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem7 int 32 regular {axi_master 0}  }
	{ sext_ln109 int 62 regular  }
	{ w2_local_7 float 32 regular {array 512 { 0 3 } 0 1 }  }
	{ w2_local_6 float 32 regular {array 512 { 0 3 } 0 1 }  }
	{ w2_local_5 float 32 regular {array 512 { 0 3 } 0 1 }  }
	{ w2_local_4 float 32 regular {array 512 { 0 3 } 0 1 }  }
	{ w2_local_3 float 32 regular {array 512 { 0 3 } 0 1 }  }
	{ w2_local_2 float 32 regular {array 512 { 0 3 } 0 1 }  }
	{ w2_local_1 float 32 regular {array 512 { 0 3 } 0 1 }  }
	{ w2_local float 32 regular {array 512 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem7", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "w2","offset": { "type": "dynamic","port_name": "w2","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln109", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem7_WDATA sc_out sc_lv 32 signal 0 } 
	{ m_axi_gmem7_WSTRB sc_out sc_lv 4 signal 0 } 
	...
	{ m_axi_gmem7_RDATA sc_in sc_lv 32 signal 0 } 
	{ m_axi_gmem7_RLAST sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem7_RID sc_in sc_lv 1 signal 0 } 
	{ m_axi_gmem7_RFIFONUM sc_in sc_lv 9 signal 0 } 
	...
	{ sext_ln109 sc_in sc_lv 62 signal 1 } 
	{ w2_local_7_address0 sc_out sc_lv 9 signal 2 } 
	{ w2_local_7_ce0 sc_out sc_logic 1 signal 2 } 
	{ w2_local_7_we0 sc_out sc_logic 1 signal 2 } 
	{ w2_local_7_d0 sc_out sc_lv 32 signal 2 } 
	{ w2_local_6_address0 sc_out sc_lv 9 signal 3 } 
	{ w2_local_6_ce0 sc_out sc_logic 1 signal 3 } 
	{ w2_local_6_we0 sc_out sc_logic 1 signal 3 } 
	{ w2_local_6_d0 sc_out sc_lv 32 signal 3 } 
	{ w2_local_5_address0 sc_out sc_lv 9 signal 4 } 
	{ w2_local_5_ce0 sc_out sc_logic 1 signal 4 } 
	{ w2_local_5_we0 sc_out sc_logic 1 signal 4 } 
	{ w2_local_5_d0 sc_out sc_lv 32 signal 4 } 
	{ w2_local_4_address0 sc_out sc_lv 9 signal 5 } 
	{ w2_local_4_ce0 sc_out sc_logic 1 signal 5 } 
	{ w2_local_4_we0 sc_out sc_logic 1 signal 5 } 
	{ w2_local_4_d0 sc_out sc_lv 32 signal 5 } 
	{ w2_local_3_address0 sc_out sc_lv 9 signal 6 } 
	{ w2_local_3_ce0 sc_out sc_logic 1 signal 6 } 
	{ w2_local_3_we0 sc_out sc_logic 1 signal 6 } 
	{ w2_local_3_d0 sc_out sc_lv 32 signal 6 } 
	{ w2_local_2_address0 sc_out sc_lv 9 signal 7 } 
	{ w2_local_2_ce0 sc_out sc_logic 1 signal 7 } 
	{ w2_local_2_we0 sc_out sc_logic 1 signal 7 } 
	{ w2_local_2_d0 sc_out sc_lv 32 signal 7 } 
	{ w2_local_1_address0 sc_out sc_lv 9 signal 8 } 
	{ w2_local_1_ce0 sc_out sc_logic 1 signal 8 } 
	{ w2_local_1_we0 sc_out sc_logic 1 signal 8 } 
	{ w2_local_1_d0 sc_out sc_lv 32 signal 8 } 
	{ w2_local_address0 sc_out sc_lv 9 signal 9 } 
	{ w2_local_ce0 sc_out sc_logic 1 signal 9 } 
	{ w2_local_we0 sc_out sc_logic 1 signal 9 } 
	{ w2_local_d0 sc_out sc_lv 32 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln109", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln109", "role": "default" }} , 
 	{ "name": "w2_local_7_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "w2_local_7", "role": "address0" }} , 
 	...
 	{ "name": "w2_local_6_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "w2_local_6", "role": "address0" }} , 
 	...
 	{ "name": "w2_local_5_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "w2_local_5", "role": "address0" }} , 
 	...
 	{ "name": "w2_local_4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "w2_local_4", "role": "address0" }} , 
 	...
 	{ "name": "w2_local_3_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "w2_local_3", "role": "address0" }} , 
 	...
 	{ "name": "w2_local_2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "w2_local_2", "role": "address0" }} , 
 	...
 	{ "name": "w2_local_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "w2_local_1", "role": "address0" }} , 
 	...
 	{ "name": "w2_local_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "w2_local", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln109 { ap_none {  { sext_ln109 in_data 0 62 } } }
	w2_local_7 { ap_memory {  { w2_local_7_address0 mem_address 1 9 }  { w2_local_7_ce0 mem_ce 1 1 }  { w2_local_7_we0 mem_we 1 1 }  { w2_local_7_d0 mem_din 1 32 } } }
	w2_local_6 { ap_memory {  { w2_local_6_address0 mem_address 1 9 }  { w2_local_6_ce0 mem_ce 1 1 }  { w2_local_6_we0 mem_we 1 1 }  { w2_local_6_d0 mem_din 1 32 } } }
	w2_local_5 { ap_memory {  { w2_local_5_address0 mem_address 1 9 }  { w2_local_5_ce0 mem_ce 1 1 }  { w2_local_5_we0 mem_we 1 1 }  { w2_local_5_d0 mem_din 1 32 } } }
	w2_local_4 { ap_memory {  { w2_local_4_address0 mem_address 1 9 }  { w2_local_4_ce0 mem_ce 1 1 }  { w2_local_4_we0 mem_we 1 1 }  { w2_local_4_d0 mem_din 1 32 } } }
	w2_local_3 { ap_memory {  { w2_local_3_address0 mem_address 1 9 }  { w2_local_3_ce0 mem_ce 1 1 }  { w2_local_3_we0 mem_we 1 1 }  { w2_local_3_d0 mem_din 1 32 } } }
	w2_local_2 { ap_memory {  { w2_local_2_address0 mem_address 1 9 }  { w2_local_2_ce0 mem_ce 1 1 }  { w2_local_2_we0 mem_we 1 1 }  { w2_local_2_d0 mem_din 1 32 } } }
	w2_local_1 { ap_memory {  { w2_local_1_address0 mem_address 1 9 }  { w2_local_1_ce0 mem_ce 1 1 }  { w2_local_1_we0 mem_we 1 1 }  { w2_local_1_d0 mem_din 1 32 } } }
	w2_local { ap_memory {  { w2_local_address0 mem_address 1 9 }  { w2_local_ce0 mem_ce 1 1 }  { w2_local_we0 mem_we 1 1 }  { w2_local_d0 mem_din 1 32 } } }
}
