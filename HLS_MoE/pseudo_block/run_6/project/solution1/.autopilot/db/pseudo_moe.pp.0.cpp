# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_6/src/pseudo_moe.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_6/src/pseudo_moe.cpp" 2
...
# 2 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_6/src/pseudo_moe.cpp" 2
...
#line 14 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_6/scripts/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=pseudo_moe
# 65 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_6/src/pseudo_moe.cpp"
...
#pragma HLS ARRAY_PARTITION variable=w3_local cyclic factor=8 dim=1
 ...
 VITIS_LOOP_99_1: for (int k = 0; k < D * D; k++) {
#pragma HLS PIPELINE II=1
 w0_local[k] = w0[k];
    }

    VITIS_LOOP_104_2: for (int k = 0; k < D * D; k++) {
#pragma HLS PIPELINE II=1
 w1_local[k] = w1[k];
    }

    VITIS_LOOP_109_3: for (int k = 0; k < D * D; k++) {
#pragma HLS PIPELINE II=1
 w2_local[k] = w2[k];
    }

    VITIS_LOOP_114_4: for (int k = 0; k < D * D; k++) {
#pragma HLS PIPELINE II=1
 w3_local[k] = w3[k];
    }

    VITIS_LOOP_119_5: for (int n = 0; n < N; n++) {
#pragma HLS PIPELINE off


 float max_logit = -1.0e30f;

        VITIS_LOOP_125_6: for (int e = 0; e < E; e++) {
            float acc = b_gate[e];

            VITIS_LOOP_128_7: for (int d = 0; d < D; d++) {
        ...
        VITIS_LOOP_142_8: for (int e = 0; e < E; e++) {
            exp_values[e] = expf(logits[e] - max_logit);
            exp_sum += exp_values[e];
        }

        VITIS_LOOP_147_9: for (int e = 0; e < E; e++) {
            gates_out[n * E + e] = exp_values[e] / exp_sum;
        }


        VITIS_LOOP_152_10: for (int d = 0; d < D; d++) {
            output[n * D + d] = 0.0f;
        }
        ...
        VITIS_LOOP_159_11: for (int o = 0; o < D; o++) {
            output[n * D + o] +=
        ...
        VITIS_LOOP_167_12: for (int o = 0; o < D; o++) {
            output[n * D + o] +=
        ...
        VITIS_LOOP_175_13: for (int o = 0; o < D; o++) {
            output[n * D + o] +=
        ...
        VITIS_LOOP_183_14: for (int o = 0; o < D; o++) {
            output[n * D + o] +=
