# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_4/src/pseudo_moe.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_4/src/pseudo_moe.cpp" 2
...
# 2 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_4/src/pseudo_moe.cpp" 2
...
#pragma HLS ARRAY_PARTITION variable=partial complete
 ...
 VITIS_LOOP_25_2: for (int lane = 0; lane < LANES; lane++) {
#pragma HLS UNROLL
 partial[lane] = 0.0f;
        }
...
#pragma HLS PIPELINE II=1
 ...
 VITIS_LOOP_34_4: for (int lane = 0; lane < LANES; lane++) {
#pragma HLS UNROLL
 const int i = g * LANES + lane;
        ...
        float acc = b[o];
        VITIS_LOOP_43_5: for (int lane = 0; lane < LANES; lane++) {
#pragma HLS UNROLL
 acc += partial[lane];
        }
...
#line 14 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_4/scripts/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=pseudo_moe
# 65 "/home/simics/HMoE/HLS_HMoE/pseudo_block/run_4/src/pseudo_moe.cpp"
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 ...
 float logits[E];
    ...
    VITIS_LOOP_88_1: for (int n = 0; n < N; n++) {
#pragma HLS PIPELINE off


 float max_logit = -1.0e30f;

        VITIS_LOOP_94_2: for (int e = 0; e < E; e++) {
            float acc = b_gate[e];

            VITIS_LOOP_97_3: for (int d = 0; d < D; d++) {
        ...
        VITIS_LOOP_111_4: for (int e = 0; e < E; e++) {
            exp_values[e] = expf(logits[e] - max_logit);
            exp_sum += exp_values[e];
        }

        VITIS_LOOP_116_5: for (int e = 0; e < E; e++) {
            gates_out[n * E + e] = exp_values[e] / exp_sum;
        }


        VITIS_LOOP_121_6: for (int d = 0; d < D; d++) {
            output[n * D + d] = 0.0f;
        }
        ...
        VITIS_LOOP_128_7: for (int o = 0; o < D; o++) {
            output[n * D + o] +=
        ...
        VITIS_LOOP_136_8: for (int o = 0; o < D; o++) {
            output[n * D + o] +=
        ...
        VITIS_LOOP_144_9: for (int o = 0; o < D; o++) {
            output[n * D + o] +=
        ...
        VITIS_LOOP_152_10: for (int o = 0; o < D; o++) {
            output[n * D + o] +=
