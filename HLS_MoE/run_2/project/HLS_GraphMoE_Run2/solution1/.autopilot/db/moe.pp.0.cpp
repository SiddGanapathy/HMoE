...
#line 18 "/home/simics/HMoE/HLS_HMoE/run_2/scripts/run_hls.tcl"
...
#pragma HLS INTERFACE mode=s_axilite port=return
 ...
 float logits[4];
    ...
    VITIS_LOOP_53_1: for (int e = 0; e < 4; e++) {
        float sum = gate_bias[e];

        VITIS_LOOP_56_2: for (int i = 0; i < 128; i++) {
#pragma HLS PIPELINE II=1
 sum += gate_weight[e][i] * input[i];
    ...
    VITIS_LOOP_67_3: for (int e = 1; e < 4; e++) {
    ...
    VITIS_LOOP_75_4: for (int e = 0; e < 4; e++) {
        exp_logits[e] = expf(logits[e] - max_logit);
        exp_sum += exp_logits[e];
    }

    VITIS_LOOP_80_5: for (int e = 0; e < 4; e++) {
        gates[e] = exp_logits[e] / exp_sum;
    }
# 94 "src/moe.cpp"
    float expert_output[4][5];

    VITIS_LOOP_96_6: for (int e = 0; e < 4; e++) {

        VITIS_LOOP_98_7: for (int obj = 0; obj < 5; obj++) {
            ...
            VITIS_LOOP_105_8: for (int i = 0; i < 32; i++) {
                float sum = b1[e][obj][i];

                VITIS_LOOP_108_9: for (int j = 0; j < 128; j++) {
#pragma HLS PIPELINE II=1
 sum += w1[e][obj][i][j] * input[j];
            ...
            VITIS_LOOP_117_10: for (int i = 0; i < 16; i++) {
                float sum = b2[e][obj][i];

                VITIS_LOOP_120_11: for (int j = 0; j < 32; j++) {
#pragma HLS PIPELINE II=1
 sum += w2[e][obj][i][j] * l1[j];
            ...
            VITIS_LOOP_129_12: for (int i = 0; i < 8; i++) {
                float sum = b3[e][obj][i];

                VITIS_LOOP_132_13: for (int j = 0; j < 16; j++) {
#pragma HLS PIPELINE II=1
 sum += w3[e][obj][i][j] * l2[j];
            ...
            VITIS_LOOP_143_14: for (int j = 0; j < 8; j++) {
#pragma HLS PIPELINE II=1
 result += w4[e][obj][0][j] * l3[j];
    ...
    VITIS_LOOP_157_15: for (int obj = 0; obj < 5; obj++) {

        float sum = 0.0f;

        VITIS_LOOP_161_16: for (int e = 0; e < 4; e++) {
