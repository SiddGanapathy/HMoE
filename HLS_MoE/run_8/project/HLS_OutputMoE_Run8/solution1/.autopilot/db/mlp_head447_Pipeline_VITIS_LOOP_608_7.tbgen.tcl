set moduleName mlp_head447_Pipeline_VITIS_LOOP_608_7
set isTopModule 0
...
set C_modelName {mlp_head447_Pipeline_VITIS_LOOP_608_7}
set C_modelType { void 0 }
set C_modelArgList {
	{ l3 float 32 regular {array 8 { 1 3 } 1 1 }  }
	{ output_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "l3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "output_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ output_out sc_out sc_lv 32 signal 1 } 
	{ output_out_ap_vld sc_out sc_logic 1 outvld 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "output_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.e0_perf_w3_0_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	output_out { ap_vld {  { output_out out_data 1 32 }  { output_out_ap_vld out_vld 1 1 } } }
}
