set moduleName output_moe_Pipeline_VITIS_LOOP_911_5
set isTopModule 0
...
set C_modelName {output_moe_Pipeline_VITIS_LOOP_911_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ gates int 32 regular {array 4 { 0 1 } 1 1 }  }
...
set portList { 
	...
	{ gates_we0 sc_out sc_logic 1 signal 0 } 
	{ gates_d0 sc_out sc_lv 32 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "output_moe_Pipeline_VITIS_LOOP_911_5",
		"Protocol" : "ap_ctrl_hs",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_911_5", "PipelineType" : "UPC",
...
set ArgLastReadFirstWriteLatency {
	output_moe_Pipeline_VITIS_LOOP_911_5 {
...
set Spec2ImplPortList { 
	gates { ap_memory {  { gates_address0 mem_address 1 2 }  { gates_ce0 mem_ce 1 1 }  { gates_we0 mem_we 1 1 }  { gates_d0 mem_din 1 32 }  { gates_address1 MemPortADDR2 1 2 }  { gates_ce1 MemPortCE2 1 1 }  { gates_q1 in_data 0 32 } } }
