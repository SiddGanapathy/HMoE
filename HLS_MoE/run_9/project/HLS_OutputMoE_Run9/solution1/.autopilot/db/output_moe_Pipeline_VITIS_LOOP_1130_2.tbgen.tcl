set moduleName output_moe_Pipeline_VITIS_LOOP_1130_2
set isTopModule 0
...
set C_modelName {output_moe_Pipeline_VITIS_LOOP_1130_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ acc float 32 regular  }
	{ zext_ln1131 int 9 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "acc", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln1131", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln1131 sc_in sc_lv 9 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln1131", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "zext_ln1131", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "output_moe_Pipeline_VITIS_LOOP_1130_2",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	output_moe_Pipeline_VITIS_LOOP_1130_2 {
		acc {Type I LastRead 0 FirstWrite -1}
		zext_ln1131 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	zext_ln1131 { ap_none {  { zext_ln1131 in_data 0 9 } } }
