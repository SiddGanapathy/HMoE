...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename l1_2 \
    op interface \
    ports { l1_2_address0 { O 5 vector } l1_2_ce0 { O 1 bit } l1_2_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sum_35_out \
    op interface \
    ports { sum_35_out { O 32 vector } sum_35_out_ap_vld { O 1 bit } } \
} "
}
