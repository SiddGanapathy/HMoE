set moduleName graph_moe_Pipeline_VITIS_LOOP_443_5
set isTopModule 0
...
set C_modelName {graph_moe_Pipeline_VITIS_LOOP_443_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ exp_logits float 32 regular {array 4 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "exp_logits", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ exp_logits_address0 sc_out sc_lv 2 signal 0 } 
	{ exp_logits_ce0 sc_out sc_logic 1 signal 0 } 
	{ exp_logits_q0 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "exp_logits_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "exp_logits", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fdiv_32ns_32ns_32_6_no_dsp_1_U20", "Parent" : "0"},
...
set Spec2ImplPortList { 
	exp_logits { ap_memory {  { exp_logits_address0 mem_address 1 2 }  { exp_logits_ce0 mem_ce 1 1 }  { exp_logits_q0 in_data 0 32 } } }
