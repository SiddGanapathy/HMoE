set moduleName graph_moe_Pipeline_VITIS_LOOP_408_1_VITIS_LOOP_412_2
set isTopModule 0
...
set C_modelName {graph_moe_Pipeline_VITIS_LOOP_408_1_VITIS_LOOP_412_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gate_weight int 32 regular {array 512 { 1 3 } 1 1 }  }
	{ input_r int 32 regular {array 128 { 1 3 } 1 1 }  }
	{ logits float 32 regular {array 4 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ gate_weight_address0 sc_out sc_lv 9 signal 0 } 
	{ gate_weight_ce0 sc_out sc_logic 1 signal 0 } 
	{ gate_weight_q0 sc_in sc_lv 32 signal 0 } 
	{ input_r_address0 sc_out sc_lv 7 signal 1 } 
	{ input_r_ce0 sc_out sc_logic 1 signal 1 } 
	{ input_r_q0 sc_in sc_lv 32 signal 1 } 
	{ logits_address0 sc_out sc_lv 2 signal 2 } 
	{ logits_ce0 sc_out sc_logic 1 signal 2 } 
	{ logits_we0 sc_out sc_logic 1 signal 2 } 
	{ logits_d0 sc_out sc_lv 32 signal 2 } 
	{ gate_bias_address0 sc_out sc_lv 2 signal 3 } 
	{ gate_bias_ce0 sc_out sc_logic 1 signal 3 } 
	{ gate_bias_q0 sc_in sc_lv 32 signal 3 } 
...
set Spec2ImplPortList { 
	...
	logits { ap_memory {  { logits_address0 mem_address 1 2 }  { logits_ce0 mem_ce 1 1 }  { logits_we0 mem_we 1 1 }  { logits_d0 mem_din 1 32 } } }
	gate_bias { ap_memory {  { gate_bias_address0 mem_address 1 2 }  { gate_bias_ce0 mem_ce 1 1 }  { gate_bias_q0 in_data 0 32 } } }
}
