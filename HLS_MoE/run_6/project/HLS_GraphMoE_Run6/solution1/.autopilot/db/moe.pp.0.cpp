...
# 1 "src/moe.h" 1
# 14 "src/moe.h"
__attribute__((sdx_kernel("graph_moe", 0))) void graph_moe(
    const float input[128],

    const float gate_weight[4][128],
    const float gate_bias[4],


    const float w1_0[5][32][128],
    const float b1_0[5][32],
    const float w2_0[5][16][32],
    const float b2_0[5][16],
    const float w3_0[5][8][16],
    const float b3_0[5][8],
    const float w4_0[5][1][8],
    const float b4_0[5][1],


    const float w1_2[5][32][128],
    const float b1_2[5][32],
    const float w2_2[5][16][32],
    const float b2_2[5][16],
    const float w3_2[5][8][16],
    const float b3_2[5][8],
    const float w4_2[5][1][8],
    const float b4_2[5][1],


    const float w1_1[5][32][128],
    const float b1_1[5][32],
    const float w2_1[5][16][32],
    const float b2_1[5][16],
    const float w3_1[5][8][16],
    const float b3_1[5][8],
    const float w4_1[5][1][8],
    const float b4_1[5][1],


    const float w1_3[5][32][128],
    const float b1_3[5][32],
    const float w2_3[5][16][32],
    const float b2_3[5][16],
    const float w3_3[5][8][16],
    const float b3_3[5][8],
    const float w4_3[5][1][8],
    const float b4_3[5][1],
...
#pragma HLS INLINE off
 ...
 VITIS_LOOP_57_1: for (int obj = 0; obj < 5; obj++)
    {
        float l1[32];
        float l2[16];
        float l3[8];
        ...
        VITIS_LOOP_64_2: for (int i = 0; i < 32; i++)
        {
            float sum = b1_0[obj][i];

            VITIS_LOOP_68_3: for (int j = 0; j < 128; j++)
            {
#pragma HLS PIPELINE II=1
 sum += w1_0[obj][i][j] * input[j];
        ...
        VITIS_LOOP_78_4: for (int i = 0; i < 16; i++)
        {
            float sum = b2_0[obj][i];

            VITIS_LOOP_82_5: for (int j = 0; j < 32; j++)
            {
#pragma HLS PIPELINE II=1
 sum += w2_0[obj][i][j] * l1[j];
        ...
        VITIS_LOOP_92_6: for (int i = 0; i < 8; i++)
        {
            float sum = b3_0[obj][i];

            VITIS_LOOP_96_7: for (int j = 0; j < 16; j++)
            {
#pragma HLS PIPELINE II=1
 sum += w3_0[obj][i][j] * l2[j];
        ...
        VITIS_LOOP_108_8: for (int j = 0; j < 8; j++)
        {
#pragma HLS PIPELINE II=1
 result += w4_0[obj][0][j] * l3[j];
    ...
    VITIS_LOOP_122_9: for (int obj = 0; obj < 5; obj++)
    {
        float l1[32];
        float l2[16];
        float l3[8];
        ...
        VITIS_LOOP_129_10: for (int i = 0; i < 32; i++)
        {
            float sum = b1_1[obj][i];

            VITIS_LOOP_133_11: for (int j = 0; j < 128; j++)
            {
#pragma HLS PIPELINE II=1
 sum += w1_1[obj][i][j] * input[j];
        ...
        VITIS_LOOP_143_12: for (int i = 0; i < 16; i++)
        {
            float sum = b2_1[obj][i];

            VITIS_LOOP_147_13: for (int j = 0; j < 32; j++)
            {
#pragma HLS PIPELINE II=1
 sum += w2_1[obj][i][j] * l1[j];
        ...
        VITIS_LOOP_157_14: for (int i = 0; i < 8; i++)
        {
            float sum = b3_1[obj][i];

            VITIS_LOOP_161_15: for (int j = 0; j < 16; j++)
            {
#pragma HLS PIPELINE II=1
 sum += w3_1[obj][i][j] * l2[j];
        ...
        VITIS_LOOP_173_16: for (int j = 0; j < 8; j++)
        {
#pragma HLS PIPELINE II=1
...
{
#line 18 "/home/simics/HMoE/HLS_HMoE/run_6/scripts/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=graph_moe
# 352 "src/moe.cpp"
...
#pragma HLS INTERFACE mode=s_axilite port=return
 ...
 float logits[4];
    ...
    VITIS_LOOP_408_1: for (int e = 0; e < 4; e++)
    {
        float sum = gate_bias[e];

        VITIS_LOOP_412_2: for (int i = 0; i < 128; i++)
        {
#pragma HLS PIPELINE II=1
 sum += gate_weight[e][i] * input[i];
    ...
    VITIS_LOOP_428_3: for (int e = 1; e < 4; e++)
    {
    ...
    VITIS_LOOP_437_4: for (int e = 0; e < 4; e++)
    {
        exp_logits[e] = expf(logits[e] - max_logit);
        exp_sum += exp_logits[e];
    }

    VITIS_LOOP_443_5: for (int e = 0; e < 4; e++)
    {
...
# 463 "src/moe.cpp"
    ...
    VITIS_LOOP_515_6: for (int obj = 0; obj < 5; obj++)
    {
#pragma HLS PIPELINE II=1
