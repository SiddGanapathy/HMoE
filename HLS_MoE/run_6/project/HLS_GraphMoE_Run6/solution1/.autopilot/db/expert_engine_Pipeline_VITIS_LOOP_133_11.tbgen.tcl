set moduleName expert_engine_Pipeline_VITIS_LOOP_133_11
set isTopModule 0
...
set C_modelName {expert_engine_Pipeline_VITIS_LOOP_133_11}
set C_modelType { void 0 }
set C_modelArgList {
	{ sum_24 float 32 regular  }
	{ empty int 15 regular  }
	{ w1_2 int 32 regular {array 20480 { 1 3 } 1 1 }  }
	{ input_r int 32 regular {array 128 { 1 3 } 1 1 }  }
	{ sum_29_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "sum_24", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_29_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sum_24 sc_in sc_lv 32 signal 0 } 
	{ empty sc_in sc_lv 15 signal 1 } 
	{ w1_2_address0 sc_out sc_lv 15 signal 2 } 
	{ w1_2_ce0 sc_out sc_logic 1 signal 2 } 
	{ w1_2_q0 sc_in sc_lv 32 signal 2 } 
	{ input_r_address0 sc_out sc_lv 7 signal 3 } 
	{ input_r_ce0 sc_out sc_logic 1 signal 3 } 
	{ input_r_q0 sc_in sc_lv 32 signal 3 } 
	{ sum_29_out sc_out sc_lv 32 signal 4 } 
	{ sum_29_out_ap_vld sc_out sc_logic 1 outvld 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_24", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_24", "role": "default" }} , 
 	...
 	{ "name": "sum_29_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_29_out", "role": "default" }} , 
 	{ "name": "sum_29_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sum_29_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	sum_24 { ap_none {  { sum_24 in_data 0 32 } } }
	empty { ap_none {  { empty in_data 0 15 } } }
	w1_2 { ap_memory {  { w1_2_address0 mem_address 1 15 }  { w1_2_ce0 mem_ce 1 1 }  { w1_2_q0 in_data 0 32 } } }
	input_r { ap_memory {  { input_r_address0 mem_address 1 7 }  { input_r_ce0 mem_ce 1 1 }  { input_r_q0 in_data 0 32 } } }
	sum_29_out { ap_vld {  { sum_29_out out_data 1 32 }  { sum_29_out_ap_vld out_vld 1 1 } } }
}
