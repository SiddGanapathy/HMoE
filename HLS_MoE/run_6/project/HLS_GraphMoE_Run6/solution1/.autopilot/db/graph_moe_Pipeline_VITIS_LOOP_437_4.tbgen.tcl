set moduleName graph_moe_Pipeline_VITIS_LOOP_437_4
set isTopModule 0
...
set C_modelName {graph_moe_Pipeline_VITIS_LOOP_437_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ logits float 32 regular {array 4 { 1 3 } 1 1 }  }
	{ max_logit_1_reload float 32 regular  }
	{ exp_logits float 32 regular {array 4 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "logits", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "exp_logits", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ logits_address0 sc_out sc_lv 2 signal 0 } 
	{ logits_ce0 sc_out sc_logic 1 signal 0 } 
	{ logits_q0 sc_in sc_lv 32 signal 0 } 
	{ max_logit_1_reload sc_in sc_lv 32 signal 1 } 
	{ exp_logits_address0 sc_out sc_lv 2 signal 2 } 
	{ exp_logits_ce0 sc_out sc_logic 1 signal 2 } 
	{ exp_logits_we0 sc_out sc_logic 1 signal 2 } 
	{ exp_logits_d0 sc_out sc_lv 32 signal 2 } 
	{ exp_sum_out sc_out sc_lv 32 signal 3 } 
	{ exp_sum_out_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "logits_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "logits", "role": "address0" }} , 
 	...
 	{ "name": "exp_logits_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "exp_logits", "role": "address0" }} , 
 	{ "name": "exp_logits_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "exp_logits", "role": "ce0" }} , 
 	{ "name": "exp_logits_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "exp_logits", "role": "we0" }} , 
 	{ "name": "exp_logits_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "exp_logits", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fexp_32ns_32ns_32_4_full_dsp_1_U14", "Parent" : "0"},
...
set Spec2ImplPortList { 
	logits { ap_memory {  { logits_address0 mem_address 1 2 }  { logits_ce0 mem_ce 1 1 }  { logits_q0 in_data 0 32 } } }
	max_logit_1_reload { ap_none {  { max_logit_1_reload in_data 0 32 } } }
	exp_logits { ap_memory {  { exp_logits_address0 mem_address 1 2 }  { exp_logits_ce0 mem_ce 1 1 }  { exp_logits_we0 mem_we 1 1 }  { exp_logits_d0 mem_din 1 32 } } }
