set moduleName expert_engine_1_Pipeline_VITIS_LOOP_96_7
set isTopModule 0
...
set C_modelName {expert_engine.1_Pipeline_VITIS_LOOP_96_7}
set C_modelType { void 0 }
set C_modelArgList {
	{ sum_14 float 32 regular  }
	{ empty int 10 regular  }
	{ w3_1 int 32 regular {array 640 { 1 3 } 1 1 }  }
	{ l2 float 32 regular {array 16 { 1 3 } 1 1 }  }
	{ sum_20_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "sum_14", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_20_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sum_14 sc_in sc_lv 32 signal 0 } 
	...
	{ l2_address0 sc_out sc_lv 4 signal 3 } 
	{ l2_ce0 sc_out sc_logic 1 signal 3 } 
	{ l2_q0 sc_in sc_lv 32 signal 3 } 
	{ sum_20_out sc_out sc_lv 32 signal 4 } 
	{ sum_20_out_ap_vld sc_out sc_logic 1 outvld 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_14", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_14", "role": "default" }} , 
 	...
 	{ "name": "sum_20_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_20_out", "role": "default" }} , 
 	{ "name": "sum_20_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sum_20_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	sum_14 { ap_none {  { sum_14 in_data 0 32 } } }
	empty { ap_none {  { empty in_data 0 10 } } }
	w3_1 { ap_memory {  { w3_1_address0 mem_address 1 10 }  { w3_1_ce0 mem_ce 1 1 }  { w3_1_q0 in_data 0 32 } } }
	l2 { ap_memory {  { l2_address0 mem_address 1 4 }  { l2_ce0 mem_ce 1 1 }  { l2_q0 in_data 0 32 } } }
	sum_20_out { ap_vld {  { sum_20_out out_data 1 32 }  { sum_20_out_ap_vld out_vld 1 1 } } }
}
