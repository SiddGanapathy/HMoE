set moduleName expert_engine_Pipeline_VITIS_LOOP_82_5
set isTopModule 0
...
set C_modelName {expert_engine_Pipeline_VITIS_LOOP_82_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ sum_25 float 32 regular  }
	{ empty int 12 regular  }
	{ w2_0 int 32 regular {array 2560 { 1 3 } 1 1 }  }
	{ l1 float 32 regular {array 32 { 1 3 } 1 1 }  }
	{ sum_32_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "sum_25", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_32_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sum_25 sc_in sc_lv 32 signal 0 } 
	{ empty sc_in sc_lv 12 signal 1 } 
	{ w2_0_address0 sc_out sc_lv 12 signal 2 } 
	{ w2_0_ce0 sc_out sc_logic 1 signal 2 } 
	{ w2_0_q0 sc_in sc_lv 32 signal 2 } 
	{ l1_address0 sc_out sc_lv 5 signal 3 } 
	{ l1_ce0 sc_out sc_logic 1 signal 3 } 
	{ l1_q0 sc_in sc_lv 32 signal 3 } 
	{ sum_32_out sc_out sc_lv 32 signal 4 } 
	{ sum_32_out_ap_vld sc_out sc_logic 1 outvld 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_25", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_25", "role": "default" }} , 
 	...
 	{ "name": "l1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "l1", "role": "address0" }} , 
 	...
 	{ "name": "sum_32_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_32_out", "role": "default" }} , 
 	{ "name": "sum_32_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sum_32_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	sum_25 { ap_none {  { sum_25 in_data 0 32 } } }
	empty { ap_none {  { empty in_data 0 12 } } }
	w2_0 { ap_memory {  { w2_0_address0 mem_address 1 12 }  { w2_0_ce0 mem_ce 1 1 }  { w2_0_q0 in_data 0 32 } } }
	l1 { ap_memory {  { l1_address0 mem_address 1 5 }  { l1_ce0 mem_ce 1 1 }  { l1_q0 in_data 0 32 } } }
	sum_32_out { ap_vld {  { sum_32_out out_data 1 32 }  { sum_32_out_ap_vld out_vld 1 1 } } }
}
