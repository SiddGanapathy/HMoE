set moduleName expert_engine_A_Pipeline_VITIS_LOOP_52_2
set isTopModule 0
...
set C_modelName {expert_engine_A_Pipeline_VITIS_LOOP_52_2}
...
set C_modelArgList {
	...
	{ sum_16_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "sum", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_16_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ w1_address0 sc_out sc_lv 17 signal 2 } 
	{ w1_ce0 sc_out sc_logic 1 signal 2 } 
	{ w1_q0 sc_in sc_lv 32 signal 2 } 
	{ input_r_address0 sc_out sc_lv 7 signal 3 } 
	{ input_r_ce0 sc_out sc_logic 1 signal 3 } 
	{ input_r_q0 sc_in sc_lv 32 signal 3 } 
	{ sum_16_out sc_out sc_lv 32 signal 4 } 
	{ sum_16_out_ap_vld sc_out sc_logic 1 outvld 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_16_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_16_out", "role": "default" }} , 
 	{ "name": "sum_16_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sum_16_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	w1 { ap_memory {  { w1_address0 mem_address 1 17 }  { w1_ce0 mem_ce 1 1 }  { w1_q0 in_data 0 32 } } }
	input_r { ap_memory {  { input_r_address0 mem_address 1 7 }  { input_r_ce0 mem_ce 1 1 }  { input_r_q0 in_data 0 32 } } }
	sum_16_out { ap_vld {  { sum_16_out out_data 1 32 }  { sum_16_out_ap_vld out_vld 1 1 } } }
}
