...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename w0 \
    op interface \
    ports { w0_address0 { O 12 vector } w0_ce0 { O 1 bit } w0_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'w0'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename b0 \
    op interface \
    ports { b0_address0 { O 5 vector } b0_ce0 { O 1 bit } b0_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'b0'"
}
}
