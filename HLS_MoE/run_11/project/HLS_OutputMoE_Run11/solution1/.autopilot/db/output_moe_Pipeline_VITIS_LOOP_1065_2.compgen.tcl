...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler output_moe_output_moe_Pipeline_VITIS_LOOP_1065_2_gate_weight_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln1066 \
    op interface \
    ports { zext_ln1066 { I 9 vector } } \
} "
}
