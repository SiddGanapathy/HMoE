...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler output_moe_output_moe_Pipeline_VITIS_LOOP_998_23_gate_weight_3_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
