set moduleName expert_engine_B_Pipeline_VITIS_LOOP_598_231
set isTopModule 0
...
set C_modelName {expert_engine_B_Pipeline_VITIS_LOOP_598_231}
set C_modelType { void 0 }
set C_modelArgList {
	{ acc_4632 float 32 regular  }
	{ i_10 int 5 regular  }
	{ input_r int 32 regular {array 128 { 3 1 } 1 1 }  }
	{ acc_5290_out float 32 regular {pointer 1}  }
	{ e3_ff_w0 float 32 regular {array 4096 { 1 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "acc_4632", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "i_10", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "acc_5290_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ acc_4632 sc_in sc_lv 32 signal 0 } 
	{ i_10 sc_in sc_lv 5 signal 1 } 
	{ input_r_address1 sc_out sc_lv 7 signal 2 } 
	{ input_r_ce1 sc_out sc_logic 1 signal 2 } 
	{ input_r_q1 sc_in sc_lv 32 signal 2 } 
	{ acc_5290_out sc_out sc_lv 32 signal 3 } 
	{ acc_5290_out_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "acc_4632", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_4632", "role": "default" }} , 
 	{ "name": "i_10", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "i_10", "role": "default" }} , 
 	...
 	{ "name": "acc_5290_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_5290_out", "role": "default" }} , 
 	{ "name": "acc_5290_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "acc_5290_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	acc_4632 { ap_none {  { acc_4632 in_data 0 32 } } }
	i_10 { ap_none {  { i_10 in_data 0 5 } } }
	input_r { ap_memory {  { input_r_address1 MemPortADDR2 1 7 }  { input_r_ce1 MemPortCE2 1 1 }  { input_r_q1 in_data 0 32 } } }
	acc_5290_out { ap_vld {  { acc_5290_out out_data 1 32 }  { acc_5290_out_ap_vld out_vld 1 1 } } }
