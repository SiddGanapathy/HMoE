set moduleName expert_engine_A_Pipeline_VITIS_LOOP_598_256
set isTopModule 0
...
set C_modelName {expert_engine_A_Pipeline_VITIS_LOOP_598_256}
set C_modelType { void 0 }
set C_modelArgList {
	{ acc_9905 float 32 regular  }
	{ or_ln592_39 int 5 regular  }
	{ input_r int 32 regular {array 128 { 1 3 } 1 1 }  }
	{ acc_10563_out float 32 regular {pointer 1}  }
	{ e0_dsp_w0 float 32 regular {array 4096 { 1 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "acc_9905", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "or_ln592_39", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "acc_10563_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ acc_9905 sc_in sc_lv 32 signal 0 } 
	{ or_ln592_39 sc_in sc_lv 5 signal 1 } 
	{ input_r_address0 sc_out sc_lv 7 signal 2 } 
	{ input_r_ce0 sc_out sc_logic 1 signal 2 } 
	{ input_r_q0 sc_in sc_lv 32 signal 2 } 
	{ acc_10563_out sc_out sc_lv 32 signal 3 } 
	{ acc_10563_out_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "acc_9905", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_9905", "role": "default" }} , 
 	{ "name": "or_ln592_39", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "or_ln592_39", "role": "default" }} , 
 	...
 	{ "name": "acc_10563_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_10563_out", "role": "default" }} , 
 	{ "name": "acc_10563_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "acc_10563_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	acc_9905 { ap_none {  { acc_9905 in_data 0 32 } } }
	or_ln592_39 { ap_none {  { or_ln592_39 in_data 0 5 } } }
	input_r { ap_memory {  { input_r_address0 mem_address 1 7 }  { input_r_ce0 mem_ce 1 1 }  { input_r_q0 in_data 0 32 } } }
	acc_10563_out { ap_vld {  { acc_10563_out out_data 1 32 }  { acc_10563_out_ap_vld out_vld 1 1 } } }
