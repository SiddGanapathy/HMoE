...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler output_moe_generic_mlp_head37_Pipeline_VITIS_LOOP_767_7_e2_dsp_w3_0_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
