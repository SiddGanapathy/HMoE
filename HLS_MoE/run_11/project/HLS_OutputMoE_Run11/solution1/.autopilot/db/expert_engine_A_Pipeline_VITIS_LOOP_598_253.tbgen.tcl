set moduleName expert_engine_A_Pipeline_VITIS_LOOP_598_253
set isTopModule 0
...
set C_modelName {expert_engine_A_Pipeline_VITIS_LOOP_598_253}
set C_modelType { void 0 }
set C_modelArgList {
	{ acc_9902 float 32 regular  }
	{ zext_ln601_51 int 12 regular  }
	{ input_r int 32 regular {array 128 { 1 3 } 1 1 }  }
	{ acc_10560_out float 32 regular {pointer 1}  }
	{ e0_ff_w0 float 32 regular {array 4096 { 1 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "acc_9902", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln601_51", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "acc_10560_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ acc_9902 sc_in sc_lv 32 signal 0 } 
	{ zext_ln601_51 sc_in sc_lv 12 signal 1 } 
	{ input_r_address0 sc_out sc_lv 7 signal 2 } 
	{ input_r_ce0 sc_out sc_logic 1 signal 2 } 
	{ input_r_q0 sc_in sc_lv 32 signal 2 } 
	{ acc_10560_out sc_out sc_lv 32 signal 3 } 
	{ acc_10560_out_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "acc_9902", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_9902", "role": "default" }} , 
 	{ "name": "zext_ln601_51", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "zext_ln601_51", "role": "default" }} , 
 	...
 	{ "name": "acc_10560_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_10560_out", "role": "default" }} , 
 	{ "name": "acc_10560_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "acc_10560_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	acc_9902 { ap_none {  { acc_9902 in_data 0 32 } } }
	zext_ln601_51 { ap_none {  { zext_ln601_51 in_data 0 12 } } }
	input_r { ap_memory {  { input_r_address0 mem_address 1 7 }  { input_r_ce0 mem_ce 1 1 }  { input_r_q0 in_data 0 32 } } }
	acc_10560_out { ap_vld {  { acc_10560_out out_data 1 32 }  { acc_10560_out_ap_vld out_vld 1 1 } } }
