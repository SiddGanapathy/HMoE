set moduleName expert_engine_B_Pipeline_VITIS_LOOP_598_228
set isTopModule 0
...
set C_modelName {expert_engine_B_Pipeline_VITIS_LOOP_598_228}
set C_modelType { void 0 }
set C_modelArgList {
	{ acc_4629 float 32 regular  }
	{ zext_ln601_22 int 12 regular  }
	{ input_r int 32 regular {array 128 { 3 1 } 1 1 }  }
	{ acc_5287_out float 32 regular {pointer 1}  }
	{ e3_lut_w0 float 32 regular {array 4096 { 1 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "acc_4629", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln601_22", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "acc_5287_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ acc_4629 sc_in sc_lv 32 signal 0 } 
	{ zext_ln601_22 sc_in sc_lv 12 signal 1 } 
	{ input_r_address1 sc_out sc_lv 7 signal 2 } 
	{ input_r_ce1 sc_out sc_logic 1 signal 2 } 
	{ input_r_q1 sc_in sc_lv 32 signal 2 } 
	{ acc_5287_out sc_out sc_lv 32 signal 3 } 
	{ acc_5287_out_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "acc_4629", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_4629", "role": "default" }} , 
 	{ "name": "zext_ln601_22", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "zext_ln601_22", "role": "default" }} , 
 	...
 	{ "name": "acc_5287_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_5287_out", "role": "default" }} , 
 	{ "name": "acc_5287_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "acc_5287_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	acc_4629 { ap_none {  { acc_4629 in_data 0 32 } } }
	zext_ln601_22 { ap_none {  { zext_ln601_22 in_data 0 12 } } }
	input_r { ap_memory {  { input_r_address1 MemPortADDR2 1 7 }  { input_r_ce1 MemPortCE2 1 1 }  { input_r_q1 in_data 0 32 } } }
	acc_5287_out { ap_vld {  { acc_5287_out out_data 1 32 }  { acc_5287_out_ap_vld out_vld 1 1 } } }
