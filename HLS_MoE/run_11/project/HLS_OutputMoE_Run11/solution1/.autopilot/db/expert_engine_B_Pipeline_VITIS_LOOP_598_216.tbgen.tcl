set moduleName expert_engine_B_Pipeline_VITIS_LOOP_598_216
set isTopModule 0
...
set C_modelName {expert_engine_B_Pipeline_VITIS_LOOP_598_216}
set C_modelType { void 0 }
set C_modelArgList {
	{ acc_2649 float 32 regular  }
	{ zext_ln601_10 int 12 regular  }
	{ input_r int 32 regular {array 128 { 3 1 } 1 1 }  }
	{ acc_3307_out float 32 regular {pointer 1}  }
	{ e1_dsp_w0 float 32 regular {array 4096 { 1 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "acc_2649", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln601_10", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "acc_3307_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ acc_2649 sc_in sc_lv 32 signal 0 } 
	{ zext_ln601_10 sc_in sc_lv 12 signal 1 } 
	{ input_r_address1 sc_out sc_lv 7 signal 2 } 
	{ input_r_ce1 sc_out sc_logic 1 signal 2 } 
	{ input_r_q1 sc_in sc_lv 32 signal 2 } 
	{ acc_3307_out sc_out sc_lv 32 signal 3 } 
	{ acc_3307_out_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "acc_2649", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_2649", "role": "default" }} , 
 	{ "name": "zext_ln601_10", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "zext_ln601_10", "role": "default" }} , 
 	...
 	{ "name": "acc_3307_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "acc_3307_out", "role": "default" }} , 
 	{ "name": "acc_3307_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "acc_3307_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	acc_2649 { ap_none {  { acc_2649 in_data 0 32 } } }
	zext_ln601_10 { ap_none {  { zext_ln601_10 in_data 0 12 } } }
	input_r { ap_memory {  { input_r_address1 MemPortADDR2 1 7 }  { input_r_ce1 MemPortCE2 1 1 }  { input_r_q1 in_data 0 32 } } }
	acc_3307_out { ap_vld {  { acc_3307_out out_data 1 32 }  { acc_3307_out_ap_vld out_vld 1 1 } } }
