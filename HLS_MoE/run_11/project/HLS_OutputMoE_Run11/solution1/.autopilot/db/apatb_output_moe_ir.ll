; ModuleID = '/home/simics/HMoE/HLS_HMoE/run_11/project/HLS_OutputMoE_Run11/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a5f32.12.13(float* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, float* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, float* "orig.arg.no"="0" "unpacked"="0.2" %dst_2, float* "orig.arg.no"="0" "unpacked"="0.3" %dst_3, float* "orig.arg.no"="0" "unpacked"="0.4" %dst_4, [5 x float]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #2 {
entry:
  %0 = icmp eq [5 x float]* %src, null
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a5f32.11.14(float* noalias align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst_0, float* noalias align 512 "orig.arg.no"="0" "unpacked"="0.1" %dst_1, float* noalias align 512 "orig.arg.no"="0" "unpacked"="0.2" %dst_2, float* noalias align 512 "orig.arg.no"="0" "unpacked"="0.3" %dst_3, float* noalias align 512 "orig.arg.no"="0" "unpacked"="0.4" %dst_4, [5 x float]* noalias readonly "orig.arg.no"="1" %src) #1 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a5f32.12.13(float* nonnull %dst_0, float* %dst_1, float* %dst_2, float* %dst_3, float* %dst_4, [5 x float]* nonnull %src, i64 5)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a4f32.16.17(float* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, float* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, float* "orig.arg.no"="0" "unpacked"="0.2" %dst_2, float* "orig.arg.no"="0" "unpacked"="0.3" %dst_3, [4 x float]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #2 {
entry:
  %0 = icmp eq [4 x float]* %src, null
  %1 = icmp eq float* %dst_0, null
  %2 = or i1 %1, %0
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a4f32.15.18(float* noalias align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst_0, float* noalias align 512 "orig.arg.no"="0" "unpacked"="0.1" %dst_1, float* noalias align 512 "orig.arg.no"="0" "unpacked"="0.2" %dst_2, float* noalias align 512 "orig.arg.no"="0" "unpacked"="0.3" %dst_3, [4 x float]* noalias readonly "orig.arg.no"="1" %src) #1 {
entry:
  %0 = icmp eq float* %dst_0, null
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a4f32.16.17(float* nonnull %dst_0, float* %dst_1, float* %dst_2, float* %dst_3, [4 x float]* nonnull %src, i64 4)
  br label %ret
...
entry:
  ...
  call void @onebyonecpy_hls.p0a5f32.11.14(float* align 512 %_0, float* align 512 %_1, float* align 512 %_2, float* align 512 %_3, float* align 512 %_4, [5 x float]* %2)
  call void @onebyonecpy_hls.p0a4f32.15.18(float* align 512 %_01, float* align 512 %_12, float* align 512 %_23, float* align 512 %_34, [4 x float]* %3)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a5f32.24.25([5 x float]* "orig.arg.no"="0" %dst, float* readonly "orig.arg.no"="1" "unpacked"="1.0" %src_0, float* readonly "orig.arg.no"="1" "unpacked"="1.1" %src_1, float* readonly "orig.arg.no"="1" "unpacked"="1.2" %src_2, float* readonly "orig.arg.no"="1" "unpacked"="1.3" %src_3, float* readonly "orig.arg.no"="1" "unpacked"="1.4" %src_4, i64 "orig.arg.no"="2" %num) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a5f32.23.26([5 x float]* noalias "orig.arg.no"="0" %dst, float* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src_0, float* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %src_1, float* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.2" %src_2, float* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.3" %src_3, float* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.4" %src_4) #1 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a5f32.24.25([5 x float]* nonnull %dst, float* nonnull %src_0, float* %src_1, float* %src_2, float* %src_3, float* %src_4, i64 5)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a4f32.28.29([4 x float]* "orig.arg.no"="0" %dst, float* readonly "orig.arg.no"="1" "unpacked"="1.0" %src_0, float* readonly "orig.arg.no"="1" "unpacked"="1.1" %src_1, float* readonly "orig.arg.no"="1" "unpacked"="1.2" %src_2, float* readonly "orig.arg.no"="1" "unpacked"="1.3" %src_3, i64 "orig.arg.no"="2" %num) #2 {
entry:
  %0 = icmp eq float* %src_0, null
  %1 = icmp eq [4 x float]* %dst, null
  %2 = or i1 %1, %0
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a4f32.27.30([4 x float]* noalias "orig.arg.no"="0" %dst, float* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src_0, float* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %src_1, float* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.2" %src_2, float* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.3" %src_3) #1 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a4f32.28.29([4 x float]* nonnull %dst, float* nonnull %src_0, float* %src_1, float* %src_2, float* %src_3, i64 4)
  br label %ret
...
entry:
  ...
  call void @onebyonecpy_hls.p0a5f32.23.26([5 x float]* %2, float* align 512 %_0, float* align 512 %_1, float* align 512 %_2, float* align 512 %_3, float* align 512 %_4)
  call void @onebyonecpy_hls.p0a4f32.27.30([4 x float]* %3, float* align 512 %_01, float* align 512 %_12, float* align 512 %_23, float* align 512 %_34)
  ret void
}
