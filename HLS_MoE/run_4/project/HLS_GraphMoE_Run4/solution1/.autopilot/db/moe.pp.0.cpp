...
#pragma HLS INLINE off
 ...
 float l1[32];
    ...
    float l3[8];
# 66 "src/moe.cpp"
    VITIS_LOOP_66_1: for (int i = 0; i < 32; i++)
    {
        float sum = b1[i];

        VITIS_LOOP_70_2: for (int j = 0; j < 128; j++)
        {
...
# 88 "src/moe.cpp"
    VITIS_LOOP_88_3: for (int i = 0; i < 16; i++)
    {
        float sum = b2[i];

        VITIS_LOOP_92_4: for (int j = 0; j < 32; j++)
        {
#pragma HLS PIPELINE II=1
...
# 109 "src/moe.cpp"
    VITIS_LOOP_109_5: for (int i = 0; i < 8; i++)
    {
        float sum = b3[i];

        VITIS_LOOP_113_6: for (int j = 0; j < 16; j++)
        {
#pragma HLS PIPELINE II=1
...
# 132 "src/moe.cpp"
    ...
    VITIS_LOOP_134_7: for (int j = 0; j < 8; j++)
    {
#pragma HLS PIPELINE II=1
...
{
#line 18 "/home/simics/HMoE/HLS_HMoE/run_4/scripts/run_hls.tcl"
...
# 218 "src/moe.cpp"
 float logits[4];
    ...
    VITIS_LOOP_220_1: for (int e = 0; e < 4; e++)
    {
        float sum = gate_bias[e];

        VITIS_LOOP_224_2: for (int i = 0; i < 128; i++)
        {
#pragma HLS PIPELINE II=1
...
# 241 "src/moe.cpp"
    ...
    VITIS_LOOP_243_3: for (int e = 1; e < 4; e++)
    {
    ...
    VITIS_LOOP_253_4: for (int e = 0; e < 4; e++)
    {
    ...
    VITIS_LOOP_260_5: for (int e = 0; e < 4; e++)
    {
...
# 316 "src/moe.cpp"
    VITIS_LOOP_316_6: for (int obj = 0; obj < 5; obj++)
    {
...
# 371 "src/moe.cpp"
    VITIS_LOOP_371_7: for (int obj = 0; obj < 5; obj++)
    {
...
# 430 "src/moe.cpp"
    VITIS_LOOP_430_8: for (int obj = 0; obj < 5; obj++)
    {
        float sum = 0.0f;

        VITIS_LOOP_434_9: for (int e = 0; e < 4; e++)
        {
