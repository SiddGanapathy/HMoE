set moduleName expert_engine_Pipeline_VITIS_LOOP_113_6
set isTopModule 0
...
set C_modelName {expert_engine_Pipeline_VITIS_LOOP_113_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ sum_10 float 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sum_10", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sum_10 sc_in sc_lv 32 signal 0 } 
	{ empty sc_in sc_lv 12 signal 1 } 
	{ w3_address0 sc_out sc_lv 12 signal 2 } 
	{ w3_ce0 sc_out sc_logic 1 signal 2 } 
	{ w3_q0 sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_10", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_10", "role": "default" }} , 
...
set Spec2ImplPortList { 
	sum_10 { ap_none {  { sum_10 in_data 0 32 } } }
	empty { ap_none {  { empty in_data 0 12 } } }
	w3 { ap_memory {  { w3_address0 mem_address 1 12 }  { w3_ce0 mem_ce 1 1 }  { w3_q0 in_data 0 32 } } }
