set moduleName graph_moe_Pipeline_VITIS_LOOP_224_2
set isTopModule 0
...
set portList { 
	...
	{ zext_ln228 sc_in sc_lv 9 signal 1 } 
	{ gate_weight_address0 sc_out sc_lv 9 signal 2 } 
	{ gate_weight_ce0 sc_out sc_logic 1 signal 2 } 
	{ gate_weight_q0 sc_in sc_lv 32 signal 2 } 
	{ input_r_address0 sc_out sc_lv 7 signal 3 } 
	{ input_r_ce0 sc_out sc_logic 1 signal 3 } 
	{ input_r_q0 sc_in sc_lv 32 signal 3 } 
	{ logits_0_out sc_out sc_lv 32 signal 4 } 
	{ logits_0_out_ap_vld sc_out sc_logic 1 outvld 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln228", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "zext_ln228", "role": "default" }} , 
 	...
 	{ "name": "logits_0_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "logits_0_out", "role": "default" }} , 
 	{ "name": "logits_0_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "logits_0_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln228 { ap_none {  { zext_ln228 in_data 0 9 } } }
	gate_weight { ap_memory {  { gate_weight_address0 mem_address 1 9 }  { gate_weight_ce0 mem_ce 1 1 }  { gate_weight_q0 in_data 0 32 } } }
	input_r { ap_memory {  { input_r_address0 mem_address 1 7 }  { input_r_ce0 mem_ce 1 1 }  { input_r_q0 in_data 0 32 } } }
	logits_0_out { ap_vld {  { logits_0_out out_data 1 32 }  { logits_0_out_ap_vld out_vld 1 1 } } }
}
