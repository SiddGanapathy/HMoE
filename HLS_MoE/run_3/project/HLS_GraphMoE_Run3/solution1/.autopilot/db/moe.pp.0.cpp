...
{
#line 18 "/home/simics/HMoE/HLS_HMoE/run_3/scripts/run_hls.tcl"
...
#pragma HLS INTERFACE mode=s_axilite port=return
 ...
 float logits[4];
    ...
    VITIS_LOOP_61_1: for (int e = 0; e < 4; e++)
    {
        float sum = gate_bias[e];

        VITIS_LOOP_65_2: for (int i = 0; i < 128; i++)
        {
#pragma HLS PIPELINE II=1
 ...
 sum += gate_weight[e][i] * input[i];
    ...
    VITIS_LOOP_82_3: for (int e = 1; e < 4; e++)
    {
#pragma HLS PIPELINE II=1
 ...
 if (logits[e] > max_logit)
    ...
    VITIS_LOOP_93_4: for (int e = 0; e < 4; e++)
    {
#pragma HLS PIPELINE II=1
 ...
 gates[e] = std::exp(logits[e] - max_logit);
    ...
    VITIS_LOOP_102_5: for (int e = 0; e < 4; e++)
    {
#pragma HLS PIPELINE II=1
...
# 201 "src/moe.cpp"
 VITIS_LOOP_201_6: for (int e = 0; e < 4; e++)
    {
#pragma HLS UNROLL factor=2
 ...
 VITIS_LOOP_210_7: for (int obj = 0; obj < 5; obj++)
        {
# 220 "src/moe.cpp"
            VITIS_LOOP_220_8: for (int i = 0; i < 32; i++)
            {
#pragma HLS PIPELINE II=1

 float sum = b1[e][obj][i];

                VITIS_LOOP_226_9: for (int j = 0; j < 128; j++)
                {
...
# 241 "src/moe.cpp"
            VITIS_LOOP_241_10: for (int i = 0; i < 16; i++)
            {
#pragma HLS PIPELINE II=1

 float sum = b2[e][obj][i];

                VITIS_LOOP_247_11: for (int j = 0; j < 32; j++)
                {
...
# 262 "src/moe.cpp"
            VITIS_LOOP_262_12: for (int i = 0; i < 8; i++)
            {
#pragma HLS PIPELINE II=1

 float sum = b3[e][obj][i];

                VITIS_LOOP_268_13: for (int j = 0; j < 16; j++)
                {
...
# 285 "src/moe.cpp"
            ...
            VITIS_LOOP_287_14: for (int j = 0; j < 8; j++)
            {
#pragma HLS PIPELINE II=1
...
# 312 "src/moe.cpp"
    VITIS_LOOP_312_15: for (int obj = 0; obj < 5; obj++)
    {
#pragma HLS PIPELINE II=1

 float sum = 0.0f;

        VITIS_LOOP_318_16: for (int e = 0; e < 4; e++)
        {
